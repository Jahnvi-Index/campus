            ...
            <div class="row gx-0 services__active">
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{ asset('frontend/assets/img/icons/services_icon01.png')}}" alt="">
                                <img class="dark" src="{{ asset('frontend/assets/img/icons/services_icon01.png')}}" alt="">
                            </div>
                            <h3 class="title"><a href="services-details.html">Communication</a></h3>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{ asset('frontend/assets/img/icons/services_icon02.png')}}" alt="">
                                <img class="dark" src="{{ asset('frontend/assets/img/icons/services_icon02.png')}}" alt="">
                            </div>
                            <h3 class="title"><a href="services-details.html">Blogging</a></h3>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{ asset('frontend/assets/img/icons/services_icon03.png')}}" alt="">
                                <img class="dark" src="{{ asset('frontend/assets/img/icons/services_icon03.png')}}" alt="">
                            </div>
                            <h3 class="title"><a href="services-details.html">Skill developement</a></h3>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{ asset('frontend/assets/img/icons/services_icon04.png')}}" alt="">
                                <img class="dark" src="{{ asset('frontend/assets/img/icons/services_icon04.png')}}" alt="">
                            </div>
                            <h3 class="title"><a href="services-details.html">Moto</a></h3>
                ...
                {{-- <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="{{ asset('frontend/assets/img/icons/services_icon04.png')}}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{ asset('frontend/assets/img/icons/services_icon04.png')}}" alt="">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="section__title text-center">
                        ...
                        <h2 class="title">A clear Communication can solve almost</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            ...
                            <img class="dark" src="{{ asset('frontend/assets/img/icons/wp_light_icon01.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                            <h4 class="title">Discover</h4>
                            <p>Discover the problem.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            ...
                            <img class="dark" src="{{ asset('frontend/assets/img/icons/wp_light_icon02.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                            <h4 class="title">Define</h4>
                            <p>define it with team.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            ...
                            <img class="dark" src="{{ asset('frontend/assets/img/icons/wp_light_icon03.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                            <h4 class="title">Develop</h4>
                            <p>develope a solution</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            ...
                            <img class="dark" src="{{ asset('frontend/assets/img/icons/wp_light_icon04.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                            <h4 class="title">Deliver</h4>
                            <p>implement of solution</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            ...
                            <div class="blog__post__tags">
                                <a href="{{ route('story.adminpost') }}">Story</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">13 febuary 2023</span>
                            <h3 class="title"><a href="{{ route('story.adminpost') }}">Facebook design is dedicated to what's new in design</a></h3>
                            <a href="{{ route('story.adminpost') }}" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            <a href="{{ route('social.adminpost') }}"><img src="assets/img/blog/blog_post_thumb02.jpg" alt=""></a>
                            <div class="blog__post__tags">
                                <a href="{{ route('social.adminpost') }}">Social</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">15 march 2023</span>
                            <h3 class="title"><a href="{{ route('social.adminpost') }}">Make communication Fast and Effectively.</a></h3>
                            <a href="{{ route('social.adminpost') }}" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            <a href="{{ route('work.adminpost') }}"><img src="assets/img/blog/blog_post_thumb03.jpg" alt=""></a>
                            <div class="blog__post__tags">
                                <a href="{{ route('work.adminpost') }}">Work</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">18 march 2023</span>
                            <h3 class="title"><a href="{{ route('work.adminpost') }}">How to increase your productivity at work - 2021</a></h3>
                            <a href="{{ route('work.adminpost') }}" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="homeContact__content">
                            <p></p>
                            <h2 class="mail"><a href="mailto:janvibhanushali.com">yourcampus11@gmail.com</a></h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="homeContact__wrap">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="homeContact__content">
                            <p></p>
                            <h2 class="mail"><a href="mailto:Info@webmail.com">janvibhanushali33@gmail.com</a></h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="homeContact__form">
